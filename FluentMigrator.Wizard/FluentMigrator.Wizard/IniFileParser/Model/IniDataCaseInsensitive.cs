using System;
using FluentMigrator.Wizard.IniParser.Model.Configuration;
using FluentMigrator.Wizard.IniParser.Model.Formatting;

namespace FluentMigrator.Wizard.IniParser.Model
{
    /// <summary>
